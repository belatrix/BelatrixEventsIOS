...
class JuryIdeaListVC : UIViewController {
  ...
  override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    if segue.identifier == K.segue.moderatorIdeaDetail {
      let dvc = segue.destination as! JuryIdeaDetailVC
...
extension JuryIdeaListVC: UITableViewDataSource , UITableViewDelegate {
